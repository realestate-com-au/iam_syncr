...
describe TestCase, "Statements":
    ...
    describe "Expanding a resource":
        ...
        it "complains if neither s3, kms, sns or iam in the resource":
            resource = mock.MagicMock(name="resource")
            ...
            self.assertEqual(resource.__contains__.mock_calls, [mock.call("iam"), mock.call("kms"), mock.call("sns"), mock.call("s3")])
